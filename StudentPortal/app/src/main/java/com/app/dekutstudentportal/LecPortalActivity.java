    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewStudentListBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // Pass the teaching course to the next activity
        ...
        // View Marks Btn
        Button viewMarksBtn = findViewById(R.id.viewMarksBtn);
        viewMarksBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // Start the ViewMarksActivity with the teachingCourse information
                Intent intent = new Intent(LecPortalActivity.this, ViewMarksActivity.class);
                intent.putExtra("teachingCourse", teachingCourse);
                startActivity(intent);
            }
        });
