...
public class LecRegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // New view initialization for password visibility toggle
        visibilityTogglePass = findViewById(R.id.visibility_toggle_lec_pass);
        visibilityToggleConfirmPass = findViewById(R.id.visibility_toggle_lec_confirm_pass);
    ...
    private void registerUser() {
        ...
        // Validate pass length and match
        ...
        db.collection("lecturer_details")
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful() && !task.getResult().isEmpty()) {
                        ...
                        // Update the existing doc in Firebase DB
                        db.collection("lecturer_details")
                                .document(userId)
                                .set(user)
    ...
    // New method for pass visibility toggle
