...
public class StudentLandingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Fetch and populate categories in the categorySpinner
        fetchAndPopulateCategories();

        // Check if the user has already registered for a semester
    ...
    private void fetchAndPopulateCategories() {
        // Fetch categories from the Firestore collection and populate the categorySpinner
    ...
    private void registerSelectedCourse() {
        ...
        // Update the student's details in the Firestore collection
        db.collection("student_details")
                .document(mAuth.getUid())
